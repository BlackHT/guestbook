...
pipeline {
    ...
    environment {
        ...
        strDockerImage ="evan0680/cicd_guestbook:${strDockerTag}"
    }

    stages {
        stage('Checkout') {
            steps {
                git branch: 'master', url:'https://github.com/BlackHT/guestbook.git'
            }
        }
        stage('Build') {
            steps {
            ...
            steps{
                ...
                withSonarQubeEnv('SonarQube-Server'){
                    sh '''
                        ...
                        -Dsonar.login=bb55a035e2c0330a2fc958130843cceef52ed44e
                    '''
                }
                */
            }
        ...
        stage('Docker Image Push') {
            steps {
                script {
                    docker.withRegistry('', 'DockerHub_evan0680') {
                        oDockImage.push()
                    }
                }
            }
